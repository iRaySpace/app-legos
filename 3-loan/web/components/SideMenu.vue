<template>
    <aside class="h-screen w-64 flex-col overflow-y-hidden border-r border-gray-200 bg-white">
        ...
        <!-- Nav Container -->
        <div id="side-menu-nav-container" class="flex flex-col overflow-y-auto">
            <nav class="px-3 py-4">
                <div>
                    <ul class="flex flex-col gap-1.5">
                        <li>
                            <a href="#" class="flex items-center gap-2.5 px-4 py-2 text-gray-900 rounded-lg bg-gray-100">
                                <IconsDashboard />
                                Dashboard
                            </a>
                        </li>
